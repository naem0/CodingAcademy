...
export default function Navber() {
    return (
        <header className='bg-gray-800/50 backdrop-blur-sm z-20 shadow-md shadow-indigo-800/25 top-0 sticky border-b border-indigo-800/50'>
            <nav class="text-gray-300 container w-[90%]  mx-auto">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-4">
                    <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
                        <Image src={logo} class="h-8 w-28" alt="Coding Academy Logo" />
                    </a>
                    ...
                    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                        <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
                            <li>
                                <a href="#" class="block py-2 px-3  rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-indigo-500 md:p-0 ">About</a>
                            </li>
