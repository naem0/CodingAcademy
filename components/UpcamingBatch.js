        ...
        <section>
            <div className="my-40">
                ...
                <div className="grid gap-8 mb-8 lg:grid-cols-1 mx-auto lg:max-w-[80%]  ">
                    <div className="px-5 py-10 text-center lg:px-5 lg:py-16 xl:py-20 transform hover:scale-x-110 hover:scale-y-105 transition duration-200 ease-out  mt-5 bg-gradient-to-l to-indigo-800/20 from-indigo-800/75 border border-indigo-800 rounded-3xl">
